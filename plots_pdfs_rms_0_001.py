...
cff_w_distanc1= np.loadtxt('statistics_stress_' + roughness + RMS +'.out', delimiter=',')
...
positive_zones= np.loadtxt('positive_zones_' + roughness + RMS +'.out',delimiter=',')
negative_zones= np.loadtxt('negative_zones_' + roughness + RMS +'.out',delimiter=',')
...
rupture_leng= np.loadtxt('rupture_length_'+ roughness+ RMS +'.out',delimiter=',')
...
full_pos_zone_len= np.loadtxt('full_postv_zone_len_'+ roughness+ RMS +'.out',delimiter=',')
